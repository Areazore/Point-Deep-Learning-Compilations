...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='pointnet_sem_seg', help='模型名称')
    parser.add_argument('--batch_size', type=int, default=16, help='训练时的批处理大小')
    parser.add_argument('--epoch', default=32, type=int, help='训练轮数')
    ...
    parser.add_argument('--npoint', type=int, default=4096, help='点数')
    parser.add_argument('--step_size', type=int, default=10, help='学习率衰减步长')
    parser.add_argument('--lr_decay', type=float, default=0.7, help='学习率衰减率')
    parser.add_argument('--test_area', type=int, default=5, help='用于测试的区域，可选1-6')
